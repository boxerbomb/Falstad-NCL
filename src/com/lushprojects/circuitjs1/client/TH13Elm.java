...
package com.lushprojects.circuitjs1.client;
    ...
    class TH13Elm extends GateElm {
	public TH13Elm(int xx, int yy) {
	    super(xx, yy); 
	    
	}
	public TH13Elm(int xa, int ya, int xb, int yb, int f,
			  StringTokenizer st) {
	    super(xa, ya, xb, yb, f, st);
	}
	
	String getGateText() { return "TH13"; }
	...
	String getGateName() { return "TH13 gate"; }
