...
package com.lushprojects.circuitjs1.client;
    ...
    class TH24Elm extends GateElm {
	public TH24Elm(int xx, int yy) {
	    super(xx, yy); 
	    
	}
	public TH24Elm(int xa, int ya, int xb, int yb, int f,
			  StringTokenizer st) {
	    super(xa, ya, xb, yb, f, st);
	}
	
	String getGateText() { return "TH24"; }
	...
	String getGateName() { return "TH24 gate"; }
