...
package com.lushprojects.circuitjs1.client;
    ...
    class THand0Elm extends GateElm {
	public THand0Elm(int xx, int yy) {
	    super(xx, yy); 
	    
	}
	public THand0Elm(int xa, int ya, int xb, int yb, int f,
			  StringTokenizer st) {
	    super(xa, ya, xb, yb, f, st);
	}
	
	String getGateText() { return "THand0"; }
	...
	String getGateName() { return "THand0 gate"; }
	...
	boolean calcFunction() {
	    ...
	    if( (a_in&b_in) || (b_in && c_in) || (a_in && d_in) ){
		f = true;
	    }else if(count==0){
		f = false;
	    }
