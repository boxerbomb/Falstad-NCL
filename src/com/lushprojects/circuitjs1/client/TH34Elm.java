...
package com.lushprojects.circuitjs1.client;
    ...
    class TH34Elm extends GateElm {
	public TH34Elm(int xx, int yy) {
	    super(xx, yy); 
	    
	}
	public TH34Elm(int xa, int ya, int xb, int yb, int f,
			  StringTokenizer st) {
	    super(xa, ya, xb, yb, f, st);
	}
	
	String getGateText() { return "TH34"; }
	...
	String getGateName() { return "TH34 gate"; }
