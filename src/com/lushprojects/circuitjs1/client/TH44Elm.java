...
package com.lushprojects.circuitjs1.client;
    ...
    class TH44Elm extends GateElm {
	public TH44Elm(int xx, int yy) {
	    super(xx, yy); 
	    
	}
	public TH44Elm(int xa, int ya, int xb, int yb, int f,
			  StringTokenizer st) {
	    super(xa, ya, xb, yb, f, st);
	}
	
	String getGateText() { return "TH44"; }
	...
	String getGateName() { return "TH44 gate"; }
