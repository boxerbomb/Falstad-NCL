...
package com.lushprojects.circuitjs1.client;
    ...
    class TH44w22Elm extends GateElm {
	public TH44w22Elm(int xx, int yy) {
	    super(xx, yy); 
	    
	}
	public TH44w22Elm(int xa, int ya, int xb, int yb, int f,
			  StringTokenizer st) {
	    super(xa, ya, xb, yb, f, st);
	}
	
	String getGateText() { return "TH44w22"; }
	...
	String getGateName() { return "TH44w22 gate"; }
