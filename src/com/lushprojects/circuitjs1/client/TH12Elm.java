...
package com.lushprojects.circuitjs1.client;
    ...
    class TH12Elm extends GateElm {
	public TH12Elm(int xx, int yy) {
	    super(xx, yy); 
	    
	}
	public TH12Elm(int xa, int ya, int xb, int yb, int f,
			  StringTokenizer st) {
	    super(xa, ya, xb, yb, f, st);
	}
	
	String getGateText() { return "TH12"; }
	...
	String getGateName() { return "TH12 gate"; }
