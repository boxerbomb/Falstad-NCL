...
package com.lushprojects.circuitjs1.client;
    ...
    class TH24w22Elm extends GateElm {
	public TH24w22Elm(int xx, int yy) {
	    super(xx, yy); 
	    
	}
	public TH24w22Elm(int xa, int ya, int xb, int yb, int f,
			  StringTokenizer st) {
	    super(xa, ya, xb, yb, f, st);
	}
	
	String getGateText() { return "TH24w22"; }
	...
	String getGateName() { return "TH24w22 gate"; }
