...
package com.lushprojects.circuitjs1.client;
    ...
    class TH23Elm extends GateElm {
	public TH23Elm(int xx, int yy) {
	    super(xx, yy); 
	    
	}
	public TH23Elm(int xa, int ya, int xb, int yb, int f,
			  StringTokenizer st) {
	    super(xa, ya, xb, yb, f, st);
	}
	
	String getGateText() { return "TH23"; }
	...
	String getGateName() { return "TH23 gate"; }
