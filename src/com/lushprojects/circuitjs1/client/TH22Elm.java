...
package com.lushprojects.circuitjs1.client;
    ...
    class TH22Elm extends GateElm {
	public TH22Elm(int xx, int yy) {
	    super(xx, yy); 
	    
	}
	public TH22Elm(int xa, int ya, int xb, int yb, int f,
			  StringTokenizer st) {
	    super(xa, ya, xb, yb, f, st);
	}
	
	String getGateText() { return "TH22"; }
	...
	String getGateName() { return "TH22 gate"; }
