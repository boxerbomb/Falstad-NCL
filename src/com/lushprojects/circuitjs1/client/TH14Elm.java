...
package com.lushprojects.circuitjs1.client;
    ...
    class TH14Elm extends GateElm {
	public TH14Elm(int xx, int yy) {
	    super(xx, yy); 
	    
	}
	public TH14Elm(int xa, int ya, int xb, int yb, int f,
			  StringTokenizer st) {
	    super(xa, ya, xb, yb, f, st);
	}
	
	String getGateText() { return "TH14"; }
	...
	String getGateName() { return "TH14 gate"; }
