...
//    String baseURL = "http://www.falstad.com/circuit/";
    ...
    public void composeMainMenu(MenuBar mainMenuBar, int num) {
    	...
    	MenuBar ThresholdMenuBar = new MenuBar(true);
    	ThresholdMenuBar.addItem(getClassCheckItem(Locale.LS("Add Bit Input"), "LogicInputElm"));
    	ThresholdMenuBar.addItem(getClassCheckItem(Locale.LS("Add NCL Output"), "nclOutputDisplayElm"));
    	ThresholdMenuBar.addItem(getClassCheckItem(Locale.LS("Add TH12"), "TH12Elm"));
    	ThresholdMenuBar.addItem(getClassCheckItem(Locale.LS("Add TH22"), "TH22Elm"));
    	ThresholdMenuBar.addItem(getClassCheckItem(Locale.LS("Add TH13"), "TH13Elm"));
    	ThresholdMenuBar.addItem(getClassCheckItem(Locale.LS("Add TH23"), "TH23Elm"));
    	ThresholdMenuBar.addItem(getClassCheckItem(Locale.LS("Add TH33"), "TH33Elm"));
    	ThresholdMenuBar.addItem(getClassCheckItem(Locale.LS("Add TH23w2"), "TH23w2Elm"));
    	ThresholdMenuBar.addItem(getClassCheckItem(Locale.LS("Add TH33w2"), "TH33w2Elm"));
    	ThresholdMenuBar.addItem(getClassCheckItem(Locale.LS("Add TH14"), "TH14Elm"));
    	ThresholdMenuBar.addItem(getClassCheckItem(Locale.LS("Add TH24"), "TH24Elm"));
    	ThresholdMenuBar.addItem(getClassCheckItem(Locale.LS("Add TH34"), "TH34Elm"));
    	ThresholdMenuBar.addItem(getClassCheckItem(Locale.LS("Add TH44"), "TH44Elm"));
    	ThresholdMenuBar.addItem(getClassCheckItem(Locale.LS("Add TH24w2"), "TH24w2Elm"));
    	ThresholdMenuBar.addItem(getClassCheckItem(Locale.LS("Add TH34w2"), "TH34w2Elm"));
    	ThresholdMenuBar.addItem(getClassCheckItem(Locale.LS("Add TH44w2"), "TH44w2Elm"));
    	ThresholdMenuBar.addItem(getClassCheckItem(Locale.LS("Add TH34w3"), "TH34w3Elm"));
    	ThresholdMenuBar.addItem(getClassCheckItem(Locale.LS("Add TH44w3"), "TH44w3Elm"));
    	ThresholdMenuBar.addItem(getClassCheckItem(Locale.LS("Add TH24w22"), "TH24w22Elm"));
    	ThresholdMenuBar.addItem(getClassCheckItem(Locale.LS("Add TH24w22"), "TH24w22Elm"));
    	ThresholdMenuBar.addItem(getClassCheckItem(Locale.LS("Add TH24w22"), "TH24w22Elm"));
    	ThresholdMenuBar.addItem(getClassCheckItem(Locale.LS("Add TH54w32"), "TH54w32Elm"));
    	ThresholdMenuBar.addItem(getClassCheckItem(Locale.LS("Add TH44w322"), "TH44w322Elm"));
    	ThresholdMenuBar.addItem(getClassCheckItem(Locale.LS("Add TH54w322"), "TH54w322Elm"));
    	ThresholdMenuBar.addItem(getClassCheckItem(Locale.LS("Add THxor0"), "THxor0Elm"));
    	ThresholdMenuBar.addItem(getClassCheckItem(Locale.LS("Add THand0"), "THand0Elm"));
    	ThresholdMenuBar.addItem(getClassCheckItem(Locale.LS("Add TH24comp"), "TH24compElm"));   	
    	mainMenuBar.addItem(SafeHtmlUtils.fromTrustedString(CheckboxMenuItem.checkBoxHtml+Locale.LS("&nbsp;</div>Threshold Gates")), ThresholdMenuBar);
    	
    	
    	
    	MenuBar chipMenuBar = new MenuBar(true);
    	chipMenuBar.addItem(getClassCheckItem(Locale.LS("Add NCL Register"), "NullConventionReg"));
...
//		a[j][j]=1e-18;
	...
	case 416: return new MBBSwitchElm(x1, y1, x2, y2, f, st);
    	...
    	case 425: return new TH12Elm(x1, y1, x2, y2, f, st);
    	case 426: return new TH22Elm(x1, y1, x2, y2, f, st);
    	case 427: return new TH13Elm(x1, y1, x2, y2, f, st);
    	case 428: return new TH23Elm(x1, y1, x2, y2, f, st);
    	case 429: return new TH33Elm(x1, y1, x2, y2, f, st);
    	
    	case 430: return new TH23w2Elm(x1, y1, x2, y2, f, st);
    	case 431: return new TH33w2Elm(x1, y1, x2, y2, f, st);
    	case 432: return new TH14Elm(x1, y1, x2, y2, f, st);
    	case 433: return new TH24Elm(x1, y1, x2, y2, f, st);
    	case 434: return new TH34Elm(x1, y1, x2, y2, f, st);
    	case 435: return new TH44Elm(x1, y1, x2, y2, f, st);
    	case 436: return new TH24w2Elm(x1, y1, x2, y2, f, st);
    	case 437: return new TH34w2Elm(x1, y1, x2, y2, f, st);
    	case 438: return new TH44w2Elm(x1, y1, x2, y2, f, st);
    	case 439: return new TH34w3Elm(x1, y1, x2, y2, f, st);
    	case 440: return new TH44w3Elm(x1, y1, x2, y2, f, st);
    	
    	case 441: return new TH24w22Elm(x1, y1, x2, y2, f, st);
    	case 442: return new TH34w22Elm(x1, y1, x2, y2, f, st);
    	case 443: return new TH44w22Elm(x1, y1, x2, y2, f, st);
    	case 444: return new TH54w32Elm(x1, y1, x2, y2, f, st);
    	case 445: return new TH44w322Elm(x1, y1, x2, y2, f, st);
    	case 446: return new TH54w322Elm(x1, y1, x2, y2, f, st);
    	case 447: return new THxor0Elm(x1, y1, x2, y2, f, st);
    	case 448: return new THand0Elm(x1, y1, x2, y2, f, st);
    	case 449: return new TH24compElm(x1, y1, x2, y2, f, st);
    	
    	case 450: return new nclOutputDisplayElm(x1, y1, x2, y2, f, st);
    	case 451: return new NullConventionReg(x1, y1, x2, y2, f, st);
	...
	// if you take out RingCounterElm, it will break subcircuits
    	...
    	if (n=="TH12Elm")
		return (CircuitElm) new TH12Elm(x1, y1);
    	if (n=="TH22Elm")
		return (CircuitElm) new TH22Elm(x1, y1);
    	if (n=="TH13Elm")
		return (CircuitElm) new TH13Elm(x1, y1);
    	if (n=="TH23Elm")
		return (CircuitElm) new TH23Elm(x1, y1);
    	if (n=="TH33Elm")
		return (CircuitElm) new TH33Elm(x1, y1);
    	if (n=="TH23w2Elm")
		return (CircuitElm) new TH23w2Elm(x1, y1);
    	if (n=="TH33w2Elm")
		return (CircuitElm) new TH33w2Elm(x1, y1);
    	if (n=="TH14Elm")
		return (CircuitElm) new TH14Elm(x1, y1);
    	if (n=="TH24Elm")
		return (CircuitElm) new TH24Elm(x1, y1);
    	if (n=="TH34Elm")
		return (CircuitElm) new TH34Elm(x1, y1);
    	if (n=="TH44Elm")
		return (CircuitElm) new TH44Elm(x1, y1);
    	if (n=="TH24w2Elm")
		return (CircuitElm) new TH24w2Elm(x1, y1);
    	if (n=="TH34w2Elm")
		return (CircuitElm) new TH34w2Elm(x1, y1);
    	if (n=="TH44w2Elm")
		return (CircuitElm) new TH44w2Elm(x1, y1);
    	if (n=="TH34w3Elm")
		return (CircuitElm) new TH34w3Elm(x1, y1);
    	if (n=="TH44w3Elm")
		return (CircuitElm) new TH44w3Elm(x1, y1);
    	if (n=="TH24w22Elm")
		return (CircuitElm) new TH24w22Elm(x1, y1);
    	if (n=="TH24w22Elm")
		return (CircuitElm) new TH24w22Elm(x1, y1);
    	if (n=="TH24w22Elm")
		return (CircuitElm) new TH24w22Elm(x1, y1);
    	if (n=="TH54w32Elm")
		return (CircuitElm) new TH54w32Elm(x1, y1);
    	if (n=="TH44w322Elm")
		return (CircuitElm) new TH44w322Elm(x1, y1);
    	if (n=="TH54w322Elm")
		return (CircuitElm) new TH54w322Elm(x1, y1);
    	if (n=="THand0Elm")
		return (CircuitElm) new THand0Elm(x1, y1);
    	if (n=="THxor0Elm")
		return (CircuitElm) new THxor0Elm(x1, y1);
    	if (n=="TH24compElm")
		return (CircuitElm) new TH24compElm(x1, y1);
    	if (n=="nclOutputDisplayElm")
		return (CircuitElm) new nclOutputDisplayElm(x1, y1);
    	if (n=="NullConventionReg")
		return (CircuitElm) new NullConventionReg(x1, y1);
